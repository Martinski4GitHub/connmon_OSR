...
function GetCookie(e,t){if(null!==cookie.get("conn_"+e)){if("string"===t)return cookie.get("conn_"+e);if("number"===t)return 1*cookie.get("conn_"+e)}else{if("string"===t)return"";if("number"===t)return 0}}function SetCookie(e,t){cookie.set("conn_"+e,t,3650)}iziToast.settings({title:"connmon",timeout:5e3,resetOnHover:!1,transitionIn:"fadeInRight",transitionOut:"fadeOutRight",position:"bottomRight",messageSize:"16px",theme:"light",displayMode:"replace",layout:2,drag:!1,pauseOnHover:!1}),void 0!==window.cookie&&"function"==typeof window.cookie.get&&"function"==typeof window.cookie.set||(window.cookie={get:function(e){return window.localStorage.getItem(e)},set:function(e,t,n){window.localStorage.setItem(e,String(t))},unset:function(e){window.localStorage.removeItem(e)}});let databaseResetDone=0;var automaticModeState="ENABLED",sqlDatabaseFileSize="0 Bytes",jffsAvailableSpaceStr="0 Bytes",jffsAvailableSpaceLow="OK",daysofweek=["Mon","Tues","Wed","Thurs","Fri","Sat","Sun"],pingtestdur=60,arraysortlistlines=[],sortname="Time",sortdir="desc",AltLayout=GetCookie("AltLayout","string");""===AltLayout&&(AltLayout="false");var maxNoCharts=27,currentNoCharts=0,ShowLines=GetCookie("ShowLines","string"),ShowFill=GetCookie("ShowFill","string");""===ShowFill&&(ShowFill="origin");var DragZoom=!0,ChartPan=!1,myinterval,intervalclear=!1,pingtestrunning=!1;Chart.defaults.global.defaultFontColor="#CCC",Chart.Tooltip.positioners.cursor=function(e,t){return t};var dataintervallist=["raw","hour","day"],metriclist=["Ping","Jitter","LineQuality"],titlelist=["Ping","Jitter","Quality"],measureunitlist=["ms","ms","%"],chartlist=["daily","weekly","monthly"],timeunitlist=["hour","day","day"],intervallist=[24,7,30],bordercolourlist=["#fc8500","#42ecf5","#fff"],backgroundcolourlist=["rgba(252,133,0,0.5)","rgba(66,236,245,0.5)","rgba(255,255,255,0.5)"];function settingHint(e){e*=1;for(var t=document.getElementsByTagName("a"),n=0;n<t.length;n++)t[n].onmouseout=nd;var i="My text goes here";return 1===e&&(i="Hour(s) of day to run ping test<br />* for all<br />Valid numbers between 0 and 23<br />comma (,) separate for multiple<br />dash (-) separate for a range"),2===e&&(i="Minute(s) of day to run ping test<br />(* for all<br />Valid numbers between 0 and 59<br />comma (,) separate for multiple<br />dash (-) separate for a range"),overlib(i,0,0)}function resetZoom(){for(var e=0;e<metriclist.length;e++){var t=window["LineChart_"+metriclist[e]];null!=t&&t.resetZoom()}}function toggleDragZoom(e){var t=!0,n=!1,i="";-1!==e.value.indexOf("On")?(t=!1,n=!0,DragZoom=!1,ChartPan=!0,i="Drag Zoom Off"):(t=!0,n=!1,DragZoom=!0,ChartPan=!1,i="Drag Zoom On");for(var o=0;o<metriclist.length;o++){var a=window["LineChart_"+metriclist[o]];null!=a&&(a.options.plugins.zoom.zoom.drag=t,a.options.plugins.zoom.pan.enabled=n,e.value=i,a.update())}}function toggleLines(){""===ShowLines?(ShowLines="line",SetCookie("ShowLines","line")):(ShowLines="",SetCookie("ShowLines",""));for(var e=0;e<metriclist.length;e++){for(var t=0;t<3;t++)window["LineChart_"+metriclist[e]].options.annotation.annotations[t].type=ShowLines;window["LineChart_"+metriclist[e]].update()}}function toggleFill(){"false"===ShowFill?(ShowFill="origin",SetCookie("ShowFill","origin")):(ShowFill="false",SetCookie("ShowFill","false"));for(var e=0;e<metriclist.length;e++)window["LineChart_"+metriclist[e]].data.datasets[0].fill=ShowFill,window["LineChart_"+metriclist[e]].update()}function keyHandler(e){switch(e.keyCode){case 82:$(document).off("keydown"),resetZoom();break;case 68:$(document).off("keydown"),toggleDragZoom(document.form.btnDragZoom);break;case 70:$(document).off("keydown"),toggleFill();break;case 76:$(document).off("keydown"),toggleLines();break}}function validateIP(e){var t=e.value;e.name;return/^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/.test(t)?($(e).removeClass("invalid"),!0):($(e).addClass("invalid"),!1)}function validateDomain(e){var t=e.value;e.name;return/^(?:[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?\.)+[a-z0-9][a-z0-9-]{0,61}[a-z0-9]$/.test(t)?($(e).removeClass("invalid"),!0):($(e).addClass("invalid"),!1)}function validateNumberSetting(e,t,n){e.name;var i=1*e.value;return i>t||i<n?($(e).addClass("invalid"),!1):($(e).removeClass("invalid"),!0)}function formatNumberSetting(e){e.name;var t=1*e.value;return 0!==e.value.length&&!isNaN(t)&&(e.value=parseInt(e.value,10),!0)}function formatNumberSetting3DP(e){e.name;var t=1*e.value;return!(t<0||0===e.value.length||isNaN(t)||"."===e.value)&&(e.value=parseFloat(e.value).toFixed(3),!0)}function validateSchedule(e,t){e.name;var n=e.value.split(","),i=0;"hours"===t?i=23:"mins"===t&&(i=59),showhide("btnfixhours",!1),showhide("btnfixmins",!1);for(var o="false",a=0;a<n.length;a++)if("*"===n[a]&&0===a)o="false";else if("*"===n[a]&&0!==a)o="true";else if("*"===n[0]&&a>0)o="true";else if(""===n[a])o="true";else if(n[a].startsWith("*/"))(isNaN(1*n[a].replace("*/",""))||1*n[a].replace("*/","")>i||1*n[a].replace("*/","")<0)&&(o="true");else if(-1!==n[a].indexOf("-"))if(n[a].startsWith("-"))o="true";else for(var s=n[a].split("-"),r=0;r<s.length;r++)""===s[r]||isNaN(1*s[r])||1*s[r]>i||1*s[r]<0?o="true":1*s[r+1]<1*s[r]&&(o="true","hours"===t?showhide("btnfixhours",!0):"mins"===t&&showhide("btnfixmins",!0));else(isNaN(1*n[a])||1*n[a]>i||1*n[a]<0)&&(o="true");return"true"===o?($(e).addClass("invalid"),!1):($(e).removeClass("invalid"),!0)}function validateScheduleValue(e){e.name;var t=1*e.value,n=0,i=$("#everyxselect").val();return"hours"===i?n=24:"minutes"===i&&(n=30),t>n||t<1||e.value.length<1?($(e).addClass("invalid"),!1):($(e).removeClass("invalid"),!0)}$(document).keydown((function(e){keyHandler(e)})),$(document).keyup((function(e){$(document).keydown((function(e){keyHandler(e)}))}));const theDaysToKeepMIN=15,theDaysToKeepDEF=30,theDaysToKeepMAX=365,theDaysToKeepTXT=`(between ${theDaysToKeepMIN} and ${theDaysToKeepMAX}, default: ${theDaysToKeepDEF})`,theLastXResultsMIN=5,theLastXResultsDEF=10,theLastXResultsMAX=100,theLastXResultsTXT=`(between ${theLastXResultsMIN} and ${theLastXResultsMAX}, default: ${theLastXResultsDEF})`,thePingDurationMIN=10,thePingDurationDEF=30,thePingDurationMAX=60,thePingDurationTXT=`(between ${thePingDurationMIN} and ${thePingDurationMAX}, default: ${thePingDurationDEF})`;function validateAll(){var e=!1;return validateIP(document.form.connmon_ipaddr)||(e=!0),validateDomain(document.form.connmon_domain)||(e=!0),validateNumberSetting(document.form.connmon_pingduration,thePingDurationMAX,thePingDurationMIN)||(e=!0),validateNumberSetting(document.form.connmon_lastxresults,theLastXResultsMAX,theLastXResultsMIN)||(e=!0),validateNumberSetting(document.form.connmon_daystokeep,theDaysToKeepMAX,theDaysToKeepMIN)||(e=!0),"true"===document.form.connmon_automaticmode.value&&("EveryX"===document.form.schedulemode.value?validateScheduleValue(document.form.everyxvalue)||(e=!0):"Custom"===document.form.schedulemode.value&&(validateSchedule(document.form.connmon_schhours,"hours")||(e=!0),validateSchedule(document.form.connmon_schmins,"mins")||(e=!0))),!e||(alert("**ERROR**\nValidation for some fields failed.\nPlease correct invalid values and try again."),!1)}function fixCron(e){if("hours"===e){var t=document.form.connmon_schhours.value;document.form.connmon_schhours.value=t.split("-")[0]+"-23,0-"+t.split("-")[1],validateSchedule(document.form.connmon_schhours,"hours")}else if("mins"===e){t=document.form.connmon_schmins.value;document.form.connmon_schmins.value=t.split("-")[0]+"-59,0-"+t.split("-")[1],validateSchedule(document.form.connmon_schmins,"mins")}}function changePingType(e){var t=1*e.value;e.name;0===t?(document.getElementById("rowip").style.display="",document.getElementById("rowdomain").style.display="none"):(document.getElementById("rowip").style.display="none",document.getElementById("rowdomain").style.display="")}function getTimeFormat(e,t){var n;return e*=1,"axis"===t?0===e?n={millisecond:"HH:mm:ss.SSS",second:"HH:mm:ss",minute:"HH:mm",hour:"HH:mm"}:1===e&&(n={millisecond:"h:mm:ss.SSS A",second:"h:mm:ss A",minute:"h:mm A",hour:"h A"}):"tooltip"===t&&(0===e?n="YYYY-MM-DD HH:mm:ss":1===e&&(n="YYYY-MM-DD h:mm:ss A")),n}function logarithmicFormatter(e,t,n){var i=this.options.scaleLabel.labelString;if("logarithmic"!==this.type)return isNaN(e)?e+" "+i:round(e,2).toFixed(2)+" "+i;var o=this.options.ticks.labels||{},a=o.index||["min","max"],s=o.significand||[1,2,5],r=e/Math.pow(10,Math.floor(Chart.helpers.log10(e))),l=!0===o.removeEmptyLines?void 0:"",c="";return 0===t?c="min":t===n.length-1&&(c="max"),"all"===o||-1!==s.indexOf(r)||-1!==a.indexOf(t)||-1!==a.indexOf(c)?0===e?"0 "+i:isNaN(e)?e+" "+i:round(e,2).toFixed(2)+" "+i:l}function getLimit(e,t,n,i){var o,a=0;return o="x"===t?e.map((function(e){return e.x})):e.map((function(e){return e.y})),a="max"===n?Math.max.apply(Math,o):Math.min.apply(Math,o),"max"===n&&0===a&&!1===i&&(a=1),a}function getYAxisMax(e){if("LineQuality"===e)return 100}function getAverage(e){for(var t=0,n=0;n<e.length;n++)t+=1*e[n].y;return t/e.length}function round(e,t){return Number(Math.round(e+"e"+t)+"e-"+t)}function getChartScale(e){var t="";return 0===(e*=1)?t="linear":1===e&&(t="logarithmic"),t}function getChartInterval(e){var t="raw";return 0===(e*=1)?t="raw":1===e?t="hour":2===e&&(t="day"),t}function getChartPeriod(e){var t="daily";return 0===(e*=1)?t="daily":1===e?t="weekly":2===e&&(t="monthly"),t}function drawChartNoData(e,t){document.getElementById("divLineChart_"+e).width="730",document.getElementById("divLineChart_"+e).height="500",document.getElementById("divLineChart_"+e).style.width="730px",document.getElementById("divLineChart_"+e).style.height="500px";var n=document.getElementById("divLineChart_"+e).getContext("2d");n.save(),n.textAlign="center",n.textBaseline="middle",n.font="normal normal bolder 48px Arial sans-serif",n.fillStyle="white",n.fillText(t,365,250),n.restore()}function drawChart(e,t,n,i,o){var a=getChartPeriod($("#"+e+"_Period option:selected").val()),s=getChartInterval($("#"+e+"_Interval option:selected").val()),r=timeunitlist[$("#"+e+"_Period option:selected").val()],l=intervallist[$("#"+e+"_Period option:selected").val()],c=moment(),d=null,m=moment().subtract(l,r+"s"),u="line",h=window[e+"_"+s+"_"+a];if(null!=h)if(0!==h.length){var f=h.map((function(e){return e.Metric})),g=h.map((function(e){return{x:e.Time,y:e.Value}})),p=window["LineChart_"+e],v=getTimeFormat($("#Time_Format option:selected").val(),"axis"),y=getTimeFormat($("#Time_Format option:selected").val(),"tooltip");"day"===s&&(u="bar",d=moment().endOf("day").subtract(9,"hours"),m=moment().startOf("day").subtract(l-1,r+"s").subtract(12,"hours"),c=d),"daily"===a&&"day"===s&&(r="day",l=1,d=moment().endOf("day").subtract(9,"hours"),m=moment().startOf("day").subtract(12,"hours"),c=d),factor=0,"hour"===r?factor=36e5:"day"===r&&(factor=864e5),void 0!==p&&p.destroy();var _=document.getElementById("divLineChart_"+e).getContext("2d"),b={segmentShowStroke:!1,segmentStrokeColor:"#000",animationEasing:"easeOutQuart",animationSteps:100,maintainAspectRatio:!1,animateScale:!0,hover:{mode:"point"},legend:{display:!1,position:"bottom",onClick:null},title:{display:!0,text:t},tooltips:{callbacks:{title:function(e,t){return"day"===s?moment(e[0].xLabel,"X").format("YYYY-MM-DD"):moment(e[0].xLabel,"X").format(y)},label:function(e,t){return round(t.datasets[e.datasetIndex].data[e.index].y,2).toFixed(2)+" "+n}},mode:"point",position:"cursor",intersect:!0},scales:{xAxes:[{type:"time",gridLines:{display:!0,color:"#282828"},ticks:{min:m,max:d,display:!0},time:{parser:"X",unit:r,stepSize:1,displayFormats:v}}],yAxes:[{type:getChartScale($("#"+e+"_Scale option:selected").val()),gridLines:{display:!1,color:"#282828"},scaleLabel:{display:!1,labelString:n},ticks:{display:!0,beginAtZero:!0,max:getYAxisMax(e),labels:{index:["min","max"],removeEmptyLines:!0},userCallback:logarithmicFormatter}}]},plugins:{zoom:{pan:{enabled:ChartPan,mode:"xy",rangeMin:{x:m,y:0},rangeMax:{x:c,y:getLimit(g,"y","max",!1)+.1*getLimit(g,"y","max",!1)}},zoom:{enabled:!0,drag:DragZoom,mode:"xy",rangeMin:{x:m,y:0},rangeMax:{x:c,y:getLimit(g,"y","max",!1)+.1*getLimit(g,"y","max",!1)},speed:.1}}},annotation:{drawTime:"afterDatasetsDraw",annotations:[{type:ShowLines,mode:"horizontal",scaleID:"y-axis-0",value:getAverage(g),borderColor:i,borderWidth:1,borderDash:[5,5],label:{backgroundColor:"rgba(0,0,0,0.3)",fontFamily:"sans-serif",fontSize:10,fontStyle:"bold",fontColor:"#fff",xPadding:6,yPadding:6,cornerRadius:6,position:"center",enabled:!0,xAdjust:0,yAdjust:0,content:"Avg="+round(getAverage(g),2).toFixed(2)+n}},{type:ShowLines,mode:"horizontal",scaleID:"y-axis-0",value:getLimit(g,"y","max",!0),borderColor:i,borderWidth:1,borderDash:[5,5],label:{backgroundColor:"rgba(0,0,0,0.3)",fontFamily:"sans-serif",fontSize:10,fontStyle:"bold",fontColor:"#fff",xPadding:6,yPadding:6,cornerRadius:6,position:"right",enabled:!0,xAdjust:15,yAdjust:0,content:"Max="+round(getLimit(g,"y","max",!0),2).toFixed(2)+n}},{type:ShowLines,mode:"horizontal",scaleID:"y-axis-0",value:getLimit(g,"y","min",!0),borderColor:i,borderWidth:1,borderDash:[5,5],label:{backgroundColor:"rgba(0,0,0,0.3)",fontFamily:"sans-serif",fontSize:10,fontStyle:"bold",fontColor:"#fff",xPadding:6,yPadding:6,cornerRadius:6,position:"left",enabled:!0,xAdjust:15,yAdjust:0,content:"Min="+round(getLimit(g,"y","min",!0),2).toFixed(2)+n}}]}};p=new Chart(_,{type:u,options:b,data:{labels:f,datasets:[{data:g,borderWidth:1,pointRadius:1,lineTension:0,fill:ShowFill,backgroundColor:o,borderColor:i}]}}),window["LineChart_"+e]=p}else drawChartNoData(e,"No data to display");else drawChartNoData(e,"No data to display")}function changePeriod(e){value=1*e.value,name=e.id.substring(0,e.id.indexOf("_")),2===value?$('select[id="'+name+'_Period"] option:contains(24)').text("Today"):$('select[id="'+name+'_Period"] option:contains("Today")').text("Last 24 hours")}function getLastXFile(){$.ajax({url:"/ext/connmon/lastx.htm",dataType:"text",cache:!1,error:function(e){setTimeout(getLastXFile,1e3)},success:function(e){parseLastXData(e)}})}function setGlobalDataset(e,t){if(window[e]=t,++currentNoCharts===maxNoCharts){showhide("imgConnTest",!1),showhide("conntest_text",!1),showhide("btnRunPingtest",!0),showhide("databaseSize_text",!0),pingtestrunning&&(pingtestrunning=!1,iziToast.destroy(),iziToast.success({message:"Ping test complete"}));for(var n=0;n<metriclist.length;n++)$("#"+metriclist[n]+"_Interval").val(GetCookie(metriclist[n]+"_Interval","number")),changePeriod(document.getElementById(metriclist[n]+"_Interval")),$("#"+metriclist[n]+"_Period").val(GetCookie(metriclist[n]+"_Period","number")),$("#"+metriclist[n]+"_Scale").val(GetCookie(metriclist[n]+"_Scale","number")),drawChart(metriclist[n],titlelist[n],measureunitlist[n],bordercolourlist[n],backgroundcolourlist[n]);getLastXFile()}}function redrawAllCharts(){for(var e=0;e<metriclist.length;e++){drawChartNoData(metriclist[e],"Data loading...");for(var t=0;t<chartlist.length;t++)for(var n=0;n<dataintervallist.length;n++)d3.csv("/ext/connmon/csv/"+metriclist[e]+"_"+dataintervallist[n]+"_"+chartlist[t]+".htm").then(setGlobalDataset.bind(null,metriclist[e]+"_"+dataintervallist[n]+"_"+chartlist[t]))}}function buildLastXTable(){var e='<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="sortTable">';if("false"===AltLayout){e+='<col style="width:130px;">',e+='<col style="width:200px;">',e+='<col style="width:95px;">',e+='<col style="width:90px;">',e+='<col style="width:90px;">',e+='<col style="width:110px;">',e+='<thead class="sortTableHeader">',e+="<tr>",e+='<th class="sortable" onclick="sortTable(this.innerHTML.replace(/ \\(.*\\)/,\'\'))">Time</th>',e+='<th class="sortable" onclick="sortTable(this.innerHTML.replace(/ \\(.*\\)/,\'\'))">Target</th>',e+='<th class="sortable" onclick="sortTable(this.innerHTML.replace(/ \\(.*\\)/,\'\'))">Duration (s)</th>',e+='<th class="sortable" onclick="sortTable(this.innerHTML.replace(/ \\(.*\\)/,\'\'))">Ping (ms)</th>',e+='<th class="sortable" onclick="sortTable(this.innerHTML.replace(/ \\(.*\\)/,\'\'))">Jitter (ms)</th>',e+="<th class=\"sortable\" onclick=\"sortTable(this.innerHTML.replace(/ \\(.*\\)/,'').replace(' ',''))\">Line Quality (%)</th>",e+="</tr>",e+="</thead>",e+='<tbody class="sortTableContent">';for(var t=0;t<arraysortlistlines.length;t++)e+='<tr class="sortRow">',e+="<td>"+arraysortlistlines[t].Time+"</td>",e+="<td>"+arraysortlistlines[t].Target+"</td>",e+="<td>"+arraysortlistlines[t].Duration+"</td>",e+="<td>"+arraysortlistlines[t].Ping+"</td>",e+="<td>"+arraysortlistlines[t].Jitter+"</td>",e+="<td>"+arraysortlistlines[t].LineQuality+"</td>",e+="</tr>"}else{e+='<col style="width:130px;">',e+='<col style="width:90px;">',e+='<col style="width:90px;">',e+='<col style="width:110px;">',e+='<col style="width:200px;">',e+='<col style="width:95px;">',e+='<thead class="sortTableHeader">',e+="<tr>",e+='<th class="sortable" onclick="sortTable(this.innerHTML.replace(/ \\(.*\\)/,\'\'))">Time</th>',e+='<th class="sortable" onclick="sortTable(this.innerHTML.replace(/ \\(.*\\)/,\'\'))">Ping (ms)</th>',e+='<th class="sortable" onclick="sortTable(this.innerHTML.replace(/ \\(.*\\)/,\'\'))">Jitter (ms)</th>',e+="<th class=\"sortable\" onclick=\"sortTable(this.innerHTML.replace(/ \\(.*\\)/,'').replace(' ',''))\">Line Quality (%)</th>",e+='<th class="sortable" onclick="sortTable(this.innerHTML.replace(/ \\(.*\\)/,\'\'))">Target</th>',e+='<th class="sortable" onclick="sortTable(this.innerHTML.replace(/ \\(.*\\)/,\'\'))">Duration (s)</th>',e+="</tr>",e+="</thead>",e+='<tbody class="sortTableContent">';for(t=0;t<arraysortlistlines.length;t++)e+='<tr class="sortRow">',e+="<td>"+arraysortlistlines[t].Time+"</td>",e+="<td>"+arraysortlistlines[t].Ping+"</td>",e+="<td>"+arraysortlistlines[t].Jitter+"</td>",e+="<td>"+arraysortlistlines[t].LineQuality+"</td>",e+="<td>"+arraysortlistlines[t].Target+"</td>",e+="<td>"+arraysortlistlines[t].Duration+"</td>",e+="</tr>"}return e+="</tbody>",e+="</table>"}function sortTable(sorttext){sortname=sorttext.replace("↑","").replace("↓","").trim();var sorttype="number",sortfield=sortname;switch(sortname){case"Time":sorttype="date";break;case"Target":sorttype="string";break}"string"===sorttype?-1===sorttext.indexOf("↓")&&-1===sorttext.indexOf("↑")||-1!==sorttext.indexOf("↓")?(eval("arraysortlistlines = arraysortlistlines.sort((a,b) => (a."+sortfield+" > b."+sortfield+") ? 1 : ((b."+sortfield+" > a."+sortfield+") ? -1 : 0));"),sortdir="asc"):(eval("arraysortlistlines = arraysortlistlines.sort((a,b) => (a."+sortfield+" < b."+sortfield+") ? 1 : ((b."+sortfield+" < a."+sortfield+") ? -1 : 0));"),sortdir="desc"):"number"===sorttype?-1===sorttext.indexOf("↓")&&-1===sorttext.indexOf("↑")?(eval("arraysortlistlines = arraysortlistlines.sort((a,b) => parseFloat(a."+sortfield+'.replace("m","000")) - parseFloat(b.'+sortfield+'.replace("m","000")));'),sortdir="asc"):-1!==sorttext.indexOf("↓")?(eval("arraysortlistlines = arraysortlistlines.sort((a,b) => parseFloat(a."+sortfield+'.replace("m","000")) - parseFloat(b.'+sortfield+'.replace("m","000"))); '),sortdir="asc"):(eval("arraysortlistlines = arraysortlistlines.sort((a,b) => parseFloat(b."+sortfield+'.replace("m","000")) - parseFloat(a.'+sortfield+'.replace("m","000")));'),sortdir="desc"):"date"===sorttype&&(-1===sorttext.indexOf("↓")&&-1===sorttext.indexOf("↑")||-1!==sorttext.indexOf("↓")?(eval("arraysortlistlines = arraysortlistlines.sort((a,b) => new Date(a."+sortfield+") - new Date(b."+sortfield+"));"),sortdir="asc"):(eval("arraysortlistlines = arraysortlistlines.sort((a,b) => new Date(b."+sortfield+") - new Date(a."+sortfield+"));"),sortdir="desc")),$("#sortTableContainer").empty(),$("#sortTableContainer").append(buildLastXTable()),$(".sortable").each((function(e,t){t.innerHTML.replace(/ \(.*\)/,"").replace(" ","")===sortname&&("asc"===sortdir?$(t).html(t.innerHTML+" ↑"):$(t).html(t.innerHTML+" ↓"))}))}function parseLastXData(e){var t=e.split("\n");t=t.filter(Boolean),arraysortlistlines=[];for(var n=0;n<t.length;n++)try{var i=t[n].split(","),o=new Object;o.Time=moment.unix(i[0].trim()).format("YYYY-MM-DD HH:mm:ss"),o.Ping=i[1].trim(),o.Jitter=i[2].trim(),o.LineQuality=i[3].replace("null","").trim(),o.Target=i[4].replace("null","").trim(),o.Duration=i[5].replace("null","").trim(),arraysortlistlines.push(o)}catch{}sortTable(sortname+" "+sortdir.replace("desc","↑").replace("asc","↓").trim())}function setCurrentPage(){document.form.next_page.value=window.location.pathname.substring(1),document.form.current_page.value=window.location.pathname.substring(1)}function parseCSVExport(e){for(var t="Timestamp,Ping,Jitter,LineQuality,PingTarget,PingDuration\n",n=0;n<e.length;n++){var i=e[n].Timestamp+","+e[n].Ping+","+e[n].Jitter+","+e[n].LineQuality+","+e[n].PingTarget+","+e[n].PingDuration;t+=n<e.length-1?i+"\n":i}document.getElementById("aExport").href="data:text/csv;charset=utf-8,"+encodeURIComponent(t)}function errorCSVExport(){document.getElementById("aExport").href="javascript:alert('Error exporting CSV,please refresh the page and try again')"}function jyNavigate(e,t,n){for(var i=1;i<=n;i++)0===e?($("#"+t+"Navigate"+i).show(),$("#btn"+t+"Navigate"+i).css("background",""),$("#btn"+t+"Navigate0").css({background:"#085F96",background:"-webkit-linear-gradient(#09639C 0%,#003047 100%)",background:"-o-linear-gradient(#09639C 0%,#003047 100%)",background:"linear-gradient(#09639C 0%,#003047 100%)"})):(i===e?($("#"+t+"Navigate"+i).show(),$("#btn"+t+"Navigate"+i).css({background:"#085F96",background:"-webkit-linear-gradient(#09639C 0%,#003047 100%)",background:"-o-linear-gradient(#09639C 0%,#003047 100%)",background:"linear-gradient(#09639C 0%,#003047 100%)"})):($("#"+t+"Navigate"+i).hide(),$("#btn"+t+"Navigate"+i).css("background","")),$("#btn"+t+"Navigate0").css("background",""))}function automaticTestEnableDisable(e){var t=e.name,n=e.value,i=t.substring(0,t.indexOf("_")),o=["schhours","schmins"],a=["schedulemode","everyxselect","everyxvalue"];if("false"===n){for(var s=0;s<o.length;s++)$("input[name="+i+"_"+o[s]+"]").addClass("disabled"),$("input[name="+i+"_"+o[s]+"]").prop("disabled",!0);for(s=0;s<daysofweek.length;s++)$("#"+i+"_"+daysofweek[s].toLowerCase()).prop("disabled",!0);for(s=0;s<a.length;s++)$("[name="+a[s]+"]").addClass("disabled"),$("[name="+a[s]+"]").prop("disabled",!0)}else if("true"===n){for(s=0;s<o.length;s++)$("input[name="+i+"_"+o[s]+"]").removeClass("disabled"),$("input[name="+i+"_"+o[s]+"]").prop("disabled",!1);for(s=0;s<daysofweek.length;s++)$("#"+i+"_"+daysofweek[s].toLowerCase()).prop("disabled",!1);for(s=0;s<a.length;s++)$("[name="+a[s]+"]").removeClass("disabled"),$("[name="+a[s]+"]").prop("disabled",!1)}}function scheduleModeToggle(e){e.name;var t=e.value;"EveryX"===t?(showhide("schfrequency",!0),showhide("schcustom",!1),"hours"===$("#everyxselect").val()?(showhide("spanxhours",!0),showhide("spanxminutes",!1)):"minutes"===$("#everyxselect").val()&&(showhide("spanxhours",!1),showhide("spanxminutes",!0))):"Custom"===t&&(showhide("schfrequency",!1),showhide("schcustom",!0))}function getEmailConfFile(){$.ajax({url:"/ext/connmon/email_config.htm",dataType:"text",cache:!1,error:function(e){setTimeout(getEmailConfFile,1e3)},success:function(data){var emailconfigdata=data.split("\n");emailconfigdata=emailconfigdata.filter(Boolean),emailconfigdata=emailconfigdata.filter((function(e){return-1===e.indexOf("#")}));for(var i=0;i<emailconfigdata.length;i++){let settingname=emailconfigdata[i].split("=")[0].toLowerCase(),settingvalue=emailconfigdata[i].split("=")[1].replace(/(\r\n|\n|\r)/gm,"").replace(/"/g,"");-1===settingname.indexOf("emailpwenc")&&(eval("document.form.email_"+settingname).value=settingvalue)}}})}function getCustomActionInfo(){$.ajax({url:"/ext/connmon/customactioninfo.htm",dataType:"text",error:function(e){setTimeout(getCustomActionInfo,1e3)},success:function(e){$("#customaction_details").append("\n"+e)}})}function getCustomActionList(){$.ajax({url:"/ext/connmon/customactionlist.htm",dataType:"text",cache:!1,error:function(e){setTimeout(getCustomActionList,1e3)},success:function(e){$("#customaction_details").html(e),getCustomActionInfo()}})}function getEmailpwFile(){$.ajax({url:"/ext/connmon/password.htm",dataType:"text",cache:!1,error:function(e){document.formScriptActions.action_script.value="start_addon_settings;start_connmoncustomactionlist;start_connmonemailpassword",document.formScriptActions.submit(),setTimeout(getCustomActionList,1e4),setTimeout(getEmailpwFile,1e4)},success:function(e){document.form.email_password.value=e,document.formScriptActions.action_script.value="start_addon_settings;start_connmondeleteemailpassword",document.formScriptActions.submit()}})}function getConfigFile(){$.ajax({url:"/ext/connmon/config.htm",dataType:"text",cache:!1,error:function(e){setTimeout(getConfigFile,1e3)},success:function(data){let settingname,settingvalue,equalSignIndx;var configdata=data.split("\n");configdata=configdata.filter(Boolean);for(var indx=0;indx<configdata.length;indx++)if(0!==configdata[indx].length&&null===configdata[indx].match("^[ ]*#")&&(settingname=configdata[indx].split("=")[0],equalSignIndx=configdata[indx].indexOf("="),-1!==equalSignIndx&&(settingvalue=configdata[indx].slice(equalSignIndx+1).replace(/(\r\n|\n|\r)/gm,""),null==settingname.match(/^JFFS_MSGLOGTIME/)))){if(settingname=settingname.toLowerCase(),-1!==settingname.indexOf("pingserver")){var pingserver=settingvalue;document.form.connmon_pingserver.value=pingserver,validateIP(document.form.connmon_pingserver)?(document.form.pingtype.value=0,document.form.connmon_ipaddr.value=pingserver):(document.form.pingtype.value=1,document.form.connmon_domain.value=pingserver),document.form.pingtype.onchange()}else if(-1!==settingname.indexOf("schdays"))if("*"===settingvalue)for(var i2=0;i2<daysofweek.length;i2++)$("#connmon_"+daysofweek[i2].toLowerCase()).prop("checked",!0);else for(var schdayarray=settingvalue.split(","),i2=0;i2<schdayarray.length;i2++)$("#connmon_"+schdayarray[i2].toLowerCase()).prop("checked",!0);else if("notifications_pingtest"===settingname)for(var pingtesttypearray=settingvalue.split(","),i2=0;i2<pingtesttypearray.length;i2++)$("#connmon_pingtest_"+pingtesttypearray[i2].toLowerCase()).prop("checked",!0);else if("notifications_pingtest_failed"===settingname)for(var pingtesttypearray=settingvalue.split(","),i2=0;i2<pingtesttypearray.length;i2++)$("#connmon_pingtest_failed_"+pingtesttypearray[i2].toLowerCase()).prop("checked",!0);else if("notifications_pingthreshold"===settingname)for(var pingthresholdtypearray=settingvalue.split(","),i2=0;i2<pingthresholdtypearray.length;i2++)$("#connmon_pingthreshold_"+pingthresholdtypearray[i2].toLowerCase()).prop("checked",!0);else if("notifications_jitterthreshold"===settingname)for(var jitterthresholdtypearray=settingvalue.split(","),i2=0;i2<jitterthresholdtypearray.length;i2++)$("#connmon_jitterthreshold_"+jitterthresholdtypearray[i2].toLowerCase()).prop("checked",!0);else if("notifications_linequalitythreshold"===settingname)for(var linequalitythresholdtypearray=settingvalue.split(","),i2=0;i2<linequalitythresholdtypearray.length;i2++)$("#connmon_linequalitythreshold_"+linequalitythresholdtypearray[i2].toLowerCase()).prop("checked",!0);else-1!==settingname.indexOf("notifications_email_list")||-1!==settingname.indexOf("notifications_webhook_list")||-1!==settingname.indexOf("notifications_pushover_list")?eval("document.form.connmon_"+settingname).value=settingvalue.replace(/,/g,"\n"):eval("document.form.connmon_"+settingname).value=settingvalue;-1!==settingname.indexOf("automaticmode")&&automaticTestEnableDisable($("#connmon_auto_"+document.form.connmon_automaticmode.value)[0]),-1!==settingname.indexOf("pingduration")&&(pingtestdur=document.form.connmon_pingduration.value)}document.getElementById("theDaysToKeepText").textContent=theDaysToKeepTXT,document.getElementById("theLastXResultsText").textContent=theLastXResultsTXT,document.getElementById("thePingDurationText").textContent=thePingDurationTXT,-1!==$("[name=connmon_schhours]").val().indexOf("/")&&1*$("[name=connmon_schmins]").val()==0?(document.form.schedulemode.value="EveryX",document.form.everyxselect.value="hours",document.form.everyxvalue.value=$("[name=connmon_schhours]").val().split("/")[1]):-1!==$("[name=connmon_schmins]").val().indexOf("/")&&"*"===$("[name=connmon_schhours]").val()?(document.form.schedulemode.value="EveryX",document.form.everyxselect.value="minutes",document.form.everyxvalue.value=$("[name=connmon_schmins]").val().split("/")[1]):document.form.schedulemode.value="Custom",scheduleModeToggle($("#schmode_"+$("[name=schedulemode]:checked").val().toLowerCase())[0])}})}function getStatsTitleFile(){$.ajax({url:"/ext/connmon/connstatstext.js",dataType:"script",error:function(e){setTimeout(getStatsTitleFile,2e3)},success:function(){setConnmonStatsTitle(),document.getElementById("databaseSize_text").textContent="Database Size: "+sqlDatabaseFileSize,null===jffsAvailableSpaceLow.match(/^WARNING[0-9]/)?(showhide("jffsFreeSpace_LOW",!1),showhide("jffsFreeSpace_NOTE",!1),showhide("jffsFreeSpace_WARN",!1),document.getElementById("jffsFreeSpace_text").textContent="JFFS Available: "+jffsAvailableSpaceStr):(document.getElementById("jffsFreeSpace_text").textContent="JFFS Available: ",document.getElementById("jffsFreeSpace_LOW").textContent=jffsAvailableSpaceStr,showhide("jffsFreeSpace_LOW",!0),"jffs"===document.form.connmon_storagelocation.value?(showhide("jffsFreeSpace_NOTE",!1),showhide("jffsFreeSpace_WARN",!0)):(showhide("jffsFreeSpace_WARN",!1),showhide("jffsFreeSpace_NOTE",!0))),document.getElementById("autoModeState_text").innerHTML="ENABLED"===automaticModeState?'Currently: <span style="margin-left:2px; background-color: #229652; color:#f2f2f2;">&nbsp;ENABLED&nbsp;</span>':'Currently: <span style="margin-left:2px; background-color: #C81927; color:#f2f2f2;">&nbsp;DISABLED&nbsp;</span>',1===databaseResetDone&&(currentNoCharts=0,$("#Time_Format").val(GetCookie("Time_Format","number")),redrawAllCharts(),databaseResetDone+=1),setTimeout(getStatsTitleFile,4e3)}})}function getCronFile(){$.ajax({url:"/ext/connmon/cron.js",dataType:"text",error:function(e){setTimeout(getCronFile,1e3)},success:function(e){document.form.healthcheckio_cron.value=e}})}function getEmailInfo(){$.ajax({url:"/ext/connmon/emailinfo.htm",dataType:"text",error:function(e){setTimeout(getEmailInfo,1e3)},success:function(e){$("#emailinfo").html(e)}})}function getChangelogFile(){$.ajax({url:"/ext/connmon/changelog.htm",dataType:"text",cache:!1,error:function(e){setTimeout(getChangelogFile,5e3)},success:function(e){$("#divchangelog").html(e)}})}function getVersionNumber(e){var t;return"local"===e?t=customSettings.connmon_version_local:"server"===e&&(t=customSettings.connmon_version_server),null==t?"N/A":t}function getVersionChangelogFile(){$.ajax({url:"/ext/connmon/detect_changelog.js",dataType:"script",error:function(e){setTimeout(getVersionChangelogFile,5e3)},success:function(){var e=getVersionNumber("server");$("#connmon_version_server").html('<a style="color:#FFCC00;text-decoration:underline;" href="javascript:void(0);">Updated version available: '+e+"</a>"),$("#connmon_version_server").on("mouseover",(function(){return overlib(changelog,0,0)})),$("#connmon_version_server")[0].onmouseout=nd}})}function buildLastXTableNoData(){return"<tr>",'<td colspan="6" class="nodata">',"Data loading...","</td>","</tr>","</table>",'<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="sortTable"><tr><td colspan="6" class="nodata">Data loading...</td></tr></table>'}function scriptUpdateLayout(){var e=getVersionNumber("local"),t=getVersionNumber("server");$("#connmon_version_local").text(e),e!==t&&"N/A"!==t&&(-1===t.indexOf("hotfix")?getVersionChangelogFile():$("#connmon_version_server").text(t),showhide("connmon_version_server",!0),showhide("btnChkUpdate",!1),showhide("btnDoUpdate",!0))}function initial(){setCurrentPage(),loadCustomSettings(),show_menu(),document.formScriptActions.action_script.value="start_addon_settings;start_connmoncustomactionlist;start_connmonemailpassword",document.formScriptActions.submit(),setTimeout(getCustomActionList,1e4),setTimeout(getEmailpwFile,1e4),getConfigFile(),getEmailConfFile(),getStatsTitleFile(),getEmailInfo(),getCronFile(),getChangelogFile(),$("#alternatelayout").prop("checked","false"!==AltLayout),$("#sortTableContainer").empty(),$("#sortTableContainer").append(buildLastXTableNoData()),d3.csv("/ext/connmon/csv/CompleteResults.htm").then((function(e){parseCSVExport(e)})).catch((function(){errorCSVExport()})),$("#Time_Format").val(GetCookie("Time_Format","number")),redrawAllCharts(),scriptUpdateLayout(),showhide("databaseSize_text",!0),showhide("jffsFreeSpace_text",!0),showhide("jffsFreeSpace_LOW",!1),showhide("jffsFreeSpace_WARN",!1),showhide("jffsFreeSpace_NOTE",!1),showhide("autoModeState_text",!0);var e=GetCookie("StartTab","number");0===e&&(e=1),$("#starttab").val(e),jyNavigate(e,"",5),jyNavigate(1,"Chart",3),jyNavigate(1,"NotificationType",5),jyNavigate(1,"NotificationMethod",6)}function setStartTab(e){SetCookie("StartTab",$(e).val())}function passChecked(e,t){switchType(e,t.checked,!0)}function toggleAlternateLayout(e){SetCookie("AltLayout",AltLayout=e.checked.toString()),sortTable(sortname+" "+sortdir.replace("desc","↑").replace("asc","↓").trim())}function statusUpdate(){$.ajax({url:"/ext/connmon/detect_update.js",dataType:"script",error:function(e){setTimeout(statusUpdate,1e3)},success:function(){"InProgress"===updatestatus?setTimeout(statusUpdate,1e3):(iziToast.destroy(),document.getElementById("imgChkUpdate").style.display="none",showhide("connmon_version_server",!0),"None"!==updatestatus?(customSettings.connmon_version_server=updatestatus,-1===updatestatus.indexOf("hotfix")?getVersionChangelogFile():$("#connmon_version_server").text("Updated version available: "+updatestatus),iziToast.warning({message:"New version available!"}),showhide("btnChkUpdate",!1),showhide("btnDoUpdate",!0)):(iziToast.info({message:"No updates available"}),$("#connmon_version_server").text("No updates available"),showhide("btnChkUpdate",!0),showhide("btnDoUpdate",!1)))}})}function checkUpdate(){document.formScriptActions.action_script.value="start_addon_settings;start_connmoncheckupdate",document.formScriptActions.submit(),showhide("btnChkUpdate",!1),document.getElementById("imgChkUpdate").style.display="",iziToast.info({message:"Checking for updates...",timeout:!1}),setTimeout(statusUpdate,2e3)}function doUpdate(){document.form.action_script.value="start_connmondoupdate",document.form.action_wait.value=10,showLoading(),document.form.submit()}function postConnTest(){currentNoCharts=0,$("#Time_Format").val(GetCookie("Time_Format","number")),setTimeout(getStatsTitleFile,3e3),setTimeout(redrawAllCharts,3e3)}function saveStatus(e){$.ajax({url:"/ext/connmon/detect_save.js",dataType:"script",error:function(t){setTimeout(saveStatus,1e3,e)},success:function(){"InProgress"===savestatus?setTimeout(saveStatus,1e3,e):(showhide("imgSave"+e,!1),"Success"===savestatus&&(iziToast.destroy(),iziToast.success({message:"Save successful"}),showhide("btnSave"+e,!0),loadCustomSettings(),"Navigate3"===e&&postConnTest()))}})}function saveConfig(e){switch(e){case"Navigate3":if(!validateAll())return!1;if((n=$("#"+e).find("[disabled]")).prop("disabled",!1),1*document.form.pingtype.value==0?document.form.connmon_pingserver.value=document.form.connmon_ipaddr.value:1*document.form.pingtype.value==1&&(document.form.connmon_pingserver.value=document.form.connmon_domain.value),"true"===document.form.connmon_automaticmode.value){if("EveryX"===document.form.schedulemode.value)if("hours"===document.form.everyxselect.value){var t=1*document.form.everyxvalue.value;document.form.connmon_schmins.value=0,document.form.connmon_schhours.value=24===t?0:"*/"+t}else if("minutes"===document.form.everyxselect.value){document.form.connmon_schhours.value="*";t=1*document.form.everyxvalue.value;document.form.connmon_schmins.value="*/"+t}}else automaticTestEnableDisable($("#connmon_auto_"+document.form.connmon_automaticmode.value)[0]);document.getElementById("amng_custom").value=JSON.stringify($("#"+e).find("input,select,textarea").serializeObject()),document.formScriptActions.action_script.value="start_addon_settings;start_connmonconfig",document.formScriptActions.submit(),n.prop("disabled",!0),showhide("btnSave"+e,!1),showhide("imgSave"+e,!0),iziToast.info({message:"Saving...",timeout:!1}),setTimeout(saveStatus,5e3,e);break;case"NotificationMethodNavigate1Config":(n=$("#"+e).find("[disabled]")).prop("disabled",!1),document.getElementById("amng_custom").value=JSON.stringify($("#table_connmonemailconfig").find("input,select,textarea").serializeObject()),document.formScriptActions.action_script.value="start_addon_settings;start_connmonconfig",document.formScriptActions.submit(),n.prop("disabled",!0),showhide("btnSave"+e,!1),showhide("imgSave"+e,!0),iziToast.info({message:"Saving...",timeout:!1}),setTimeout(saveStatus,5e3,e);break;case"NotificationMethodNavigate1Email":(n=$("#"+e).find("[disabled]")).prop("disabled",!1),document.getElementById("amng_custom").value=JSON.stringify($("#table_emailconfig").find("input,select,textarea").serializeObjectEmail()),document.formScriptActions.action_script.value="start_addon_settings;start_connmonemailconfig",document.formScriptActions.submit(),n.prop("disabled",!0),showhide("btnSave"+e,!1),showhide("imgSave"+e,!0),iziToast.info({message:"Saving...",timeout:!1}),setTimeout(saveStatus,5e3,e);break;default:var n;(n=$("#"+e).find("[disabled]")).prop("disabled",!1);var i=JSON.stringify($("#"+e).find("input,select,textarea").serializeObject());document.getElementById("amng_custom").value=i,document.formScriptActions.action_script.value="start_addon_settings;start_connmonconfig",document.formScriptActions.submit(),n.prop("disabled",!0),showhide("btnSave"+e,!1),showhide("imgSave"+e,!0),iziToast.info({message:"Saving...",timeout:!1}),setTimeout(saveStatus,5e3,e);break}}function getConntestResultFile(){$.ajax({url:"/ext/connmon/ping-result.htm",dataType:"text",cache:!1,error:function(e){setTimeout(getConntestResultFile,1e3)},success:function(e){var t=e.trim().split("\n");e=t.join("\n"),$("#conntest_output").html(e),document.getElementById("conntest_output").parentElement.parentElement.style.display=""}})}function testStatus(e){$.ajax({url:"/ext/connmon/detect_test.js",dataType:"script",error:function(t){setTimeout(testStatus,1e3,e)},success:function(){"InProgress"===teststatus?setTimeout(testStatus,1e3,e):(showhide("img"+e,!1),iziToast.destroy(),showhide("btn"+e,!0),"Success"===teststatus?iziToast.success({message:"Test successful"}):iziToast.error({message:"Test failed - please check configuration"}))}})}function testNotification(e){confirm("If you have made any changes, you will need to save them first. Do you want to continue?")&&(showhide("btn"+e,!1),document.formScriptActions.action_script.value="start_addon_settings;start_connmon"+e,document.formScriptActions.submit(),showhide("img"+e,!0),setTimeout(testStatus,1e3,e),iziToast.info({message:"Running test...",timeout:!1}))}function everyXToggle(e){e.name;var t=e.value;"hours"===t?(showhide("spanxhours",!0),showhide("spanxminutes",!1)):"minutes"===t&&(showhide("spanxhours",!1),showhide("spanxminutes",!0)),validateScheduleValue($("[name=everyxvalue]")[0])}$.fn.serializeObject=function(){var e=customSettings,t=this.serializeArray();return $.each(t,(function(){if(void 0!==e[this.name]&&-1!==this.name.indexOf("connmon")&&-1===this.name.indexOf("ipaddr")&&-1===this.name.indexOf("domain")&&-1===this.name.indexOf("schdays")&&-1===this.name.indexOf("pushover_list")&&-1===this.name.indexOf("pushover_list")&&-1===this.name.indexOf("webhook_list")&&-1===this.name.indexOf("connmon_version_")&&"connmon_notifications_pingtest"!==this.name&&"connmon_notifications_pingtest_failed"!==this.name&&"connmon_notifications_pingthreshold"!==this.name&&"connmon_notifications_jitterthreshold"!==this.name&&"connmon_notifications_linequalitythreshold"!==this.name?(e[this.name].push||(e[this.name]=[e[this.name]]),e[this.name].push(this.value||"")):-1!==this.name.indexOf("connmon")&&-1===this.name.indexOf("ipaddr")&&-1===this.name.indexOf("domain")&&-1===this.name.indexOf("schdays")&&-1===this.name.indexOf("pushover_list")&&-1===this.name.indexOf("pushover_list")&&-1===this.name.indexOf("webhook_list")&&-1===this.name.indexOf("connmon_version_")&&"connmon_notifications_pingtest"!==this.name&&"connmon_notifications_pingtest_failed"!==this.name&&"connmon_notifications_pingthreshold"!==this.name&&"connmon_notifications_jitterthreshold"!==this.name&&"connmon_notifications_linequalitythreshold"!==this.name&&(e[this.name]=this.value||""),-1!==this.name.indexOf("schdays")){var t=[];$.each($('input[name="connmon_schdays"]:checked'),(function(){t.push($(this).val())}));var n=t.join(",");"Mon,Tues,Wed,Thurs,Fri,Sat,Sun"===n&&(n="*"),e.connmon_schdays=n}if("connmon_notifications_pingtest"===this.name){var i=[];$.each($('input[name="connmon_notifications_pingtest"]:checked'),(function(){i.push($(this).val())})),e.connmon_notifications_pingtest=i.join(",")}if("connmon_notifications_pingtest_failed"===this.name){var o=[];$.each($('input[name="connmon_notifications_pingtest_failed"]:checked'),(function(){o.push($(this).val())})),e.connmon_notifications_pingtest_failed=o.join(",")}if("connmon_notifications_pingthreshold"===this.name){var a=[];$.each($('input[name="connmon_notifications_pingthreshold"]:checked'),(function(){a.push($(this).val())})),e.connmon_notifications_pingthreshold=a.join(",")}if("connmon_notifications_jitterthreshold"===this.name){var s=[];$.each($('input[name="connmon_notifications_jitterthreshold"]:checked'),(function(){s.push($(this).val())})),e.connmon_notifications_jitterthreshold=s.join(",")}if("connmon_notifications_linequalitythreshold"===this.name){var r=[];$.each($('input[name="connmon_notifications_linequalitythreshold"]:checked'),(function(){r.push($(this).val())})),e.connmon_notifications_linequalitythreshold=r.join(",")}-1!==this.name.indexOf("connmon_notifications_email_list")&&(e.connmon_notifications_email_list=document.getElementById("connmon_notifications_email_list").value.replace(/\n/g,"||||")),-1!==this.name.indexOf("connmon_notifications_pushover_list")&&(e.connmon_notifications_pushover_list=document.getElementById("connmon_notifications_pushover_list").value.replace(/\n/g,"||||")),-1!==this.name.indexOf("connmon_notifications_webhook_list")&&(e.connmon_notifications_webhook_list=document.getElementById("connmon_notifications_webhook_list").value.replace(/\n/g,"||||"))})),$.each(this,(function(){if(-1!==this.name.indexOf("schdays")){var t=[];$.each($('input[name="connmon_schdays"]:checked'),(function(){t.push($(this).val())})),0===t.length&&(e.connmon_schdays="*")}if("connmon_notifications_pingtest"===this.name){var n=[];$.each($('input[name="connmon_notifications_pingtest"]:checked'),(function(){n.push($(this).val())})),0===n.length&&(e.connmon_notifications_pingtest="None")}if("connmon_notifications_pingtest_failed"===this.name){var i=[];$.each($('input[name="connmon_notifications_pingtest_failed"]:checked'),(function(){i.push($(this).val())})),0===i.length&&(e.connmon_notifications_pingtest_failed="None")}if("connmon_notifications_pingthreshold"===this.name){var o=[];$.each($('input[name="connmon_notifications_pingthreshold"]:checked'),(function(){o.push($(this).val())})),0===o.length&&(e.connmon_notifications_pingthreshold="None")}if("connmon_notifications_jitterthreshold"===this.name){var a=[];$.each($('input[name="connmon_notifications_jitterthreshold"]:checked'),(function(){a.push($(this).val())})),0===a.length&&(e.connmon_notifications_jitterthreshold="None")}if("connmon_notifications_linequalitythreshold"===this.name){var s=[];$.each($('input[name="connmon_notifications_linequalitythreshold"]:checked'),(function(){s.push($(this).val())})),0===s.length&&(e.connmon_notifications_linequalitythreshold="None")}})),e},$.fn.serializeObjectEmail=function(){var e=customSettings,t=this.serializeArray();return $.each(t,(function(){void 0!==e[this.name]&&-1!==this.name.indexOf("email_")&&-1===this.name.indexOf("show_pass")?(e[this.name].push||(e[this.name]=[e[this.name]]),e[this.name].push(this.value||"")):-1!==this.name.indexOf("email_")&&-1===this.name.indexOf("show_pass")&&(e[this.name]=this.value||"")})),e};var pingcount=2;function updateConntest(){pingcount++,$.ajax({url:"/ext/connmon/detect_connmon.js",dataType:"script",error:function(e){},success:function(){"InProgress"===connmonstatus?(showhide("imgConnTest",!0),showhide("conntest_text",!0),$("#conntest_text").html("Ping test in progress - "+pingcount+"s elapsed")):"GenerateCSV"===connmonstatus?$("#conntest_text").html("Retrieving data for charts..."):"Done"===connmonstatus?(clearInterval(myinterval),!1===intervalclear&&(pingcount=2,intervalclear=!0,getConntestResultFile(),$("#conntest_text").html("Refreshing charts..."),postConnTest())):"LOCKED"===connmonstatus?(pingcount=2,clearInterval(myinterval),showhide("imgConnTest",!1),$("#conntest_text").html("Scheduled ping test already running!"),showhide("conntest_text",!0),showhide("btnRunPingtest",!0),document.getElementById("conntest_output").parentElement.parentElement.style.display="none",iziToast.destroy(),iziToast.error({message:"Ping test failed - scheduled ping test already running!"})):"InvalidServer"===connmonstatus?(pingcount=2,clearInterval(myinterval),showhide("imgConnTest",!1),$("#conntest_text").html("Specified ping server is not valid"),showhide("conntest_text",!0),showhide("btnRunPingtest",!0),document.getElementById("conntest_output").parentElement.parentElement.style.display="none",iziToast.destroy(),iziToast.error({message:"Ping test failed - Specified ping server is not valid"})):"Error"===connmonstatus&&(pingcount=2,clearInterval(myinterval),getConntestResultFile(),showhide("imgConnTest",!1),$("#conntest_text").html("Error when running ping test"),showhide("conntest_text",!0),showhide("btnRunPingtest",!0),iziToast.destroy(),iziToast.error({message:"Ping test failed. Check if WAN interface and specified ping target are up."}),postConnTest())}})}function startConnTestInterval(){intervalclear=!1,pingtestrunning=!0,myinterval=setInterval(updateConntest,1e3)}function runPingTest(){showhide("btnRunPingtest",!1),showhide("databaseSize_text",!1),$("#conntest_output").html(""),document.getElementById("conntest_output").parentElement.parentElement.style.display="none",document.formScriptActions.action_script.value="start_addon_settings;start_connmon",document.formScriptActions.submit(),showhide("imgConnTest",!0),showhide("conntest_text",!1),setTimeout(startConnTestInterval,5e3),iziToast.info({message:"Ping test started",timeout:!1})}function changeAllCharts(e){value=1*e.value,name=e.id.substring(0,e.id.indexOf("_")),SetCookie(e.id,value);for(var t=0;t<metriclist.length;t++)drawChart(metriclist[t],titlelist[t],measureunitlist[t],bordercolourlist[t],backgroundcolourlist[t])}function changeChart(e){value=1*e.value,name=e.id.substring(0,e.id.indexOf("_")),SetCookie(e.id,value),"Ping"===name?drawChart("Ping",titlelist[0],measureunitlist[0],bordercolourlist[0],backgroundcolourlist[0]):"Jitter"===name?drawChart("Jitter",titlelist[1],measureunitlist[1],bordercolourlist[1],backgroundcolourlist[1]):"LineQuality"===name&&drawChart("LineQuality",titlelist[2],measureunitlist[2],bordercolourlist[2],backgroundcolourlist[2])}
...
<button type="button" class="button_gen navbutton" onclick="jyNavigate(1,'',5);" id="btnNavigate1">Ping Test<br />and<br />Results</button>
<button type="button" class="button_gen navbutton" onclick="jyNavigate(2,'',5);" id="btnNavigate2">Charts</button>
<button type="button" class="button_gen navbutton" onclick="jyNavigate(3,'',5);" id="btnNavigate3">Utilities<br />and<br />Configuration</button>
<button type="button" class="button_gen navbutton" onclick="jyNavigate(4,'',5);" id="btnNavigate4">Notifications<br />and<br />Integrations</button>
<button type="button" class="button_gen navbutton" onclick="jyNavigate(5,'',5);" id="btnNavigate5">Changelog</button>
</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="Navigate1" style="display:none;">
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" style="border:0;" id="table_manualpingtest">
<thead class="collapsible-jquery" id="thead_manualpingtest">
<tr><td colspan="2">Manual ping test</td></tr>
</thead>
<tr>
...
<textarea cols="63" rows="4" wrap="off" readonly="readonly" id="conntest_output" class="textarea_log_table" style="border:0;resize:none;overflow-y:auto;overflow-x:hidden;">Ping test output</textarea>
</td>
</tr>
</table>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
...
<!--
**-------------------------------------**
** Added by Martinski W. [2024-Dec-22] **
**-------------------------------------**
-->
<tr class="even" id="autoModeStatus">
<th width="35%">Status of automatic ping tests</th>
<td class="settingvalue">
<span id="autoModeState_text" style="margin-left:2px; display:none; font-size: 12px; font-weight: bolder;"></span>
</td>
</tr>
<tr>
<tr class="even">
...
<button type="button" class="button_gen chartnavbutton" onclick="jyNavigate(1,'Chart',3);" id="btnChartNavigate1">Ping</button>
<button type="button" class="button_gen chartnavbutton" onclick="jyNavigate(2,'Chart',3);" id="btnChartNavigate2">Jitter</button>
<button type="button" class="button_gen chartnavbutton" onclick="jyNavigate(3,'Chart',3);" id="btnChartNavigate3">Quality</button>
<button type="button" class="button_gen chartnavbutton" onclick="jyNavigate(0,'Chart',3);" id="btnChartNavigate0">All</button>
</td>
</tr>
</table>
...
<input autocomplete="off" type="text" maxlength="2"
   class="input_3_table removespacing" name="connmon_pingduration" value="60"
   onkeypress="return validator.isNumber(this,event)"
   onblur="validateNumberSetting(this,thePingDurationMAX,thePingDurationMIN);formatNumberSetting(this)"
   onkeyup="validateNumberSetting(this,thePingDurationMAX,thePingDurationMIN)" data-lpignore="true"/>
&nbsp;seconds <span id="thePingDurationText" style="margin-left:4px; color:#FFCC00;"></span>
</td>
</tr>
...
<input autocomplete="off" type="text" maxlength="3"
   class="input_6_table removespacing" name="connmon_lastxresults" value="10"
   onkeypress="return validator.isNumber(this,event)"
...
<td class="settingvalue">
<input autocomplete="off" type="text" maxlength="3"
   class="input_6_table removespacing" name="connmon_daystokeep" value="30"
   onkeypress="return validator.isNumber(this,event)"
...
<td class="settingvalue">
<input type="radio" name="connmon_automaticmode"
	id="connmon_auto_true" onchange="automaticTestEnableDisable(this)" class="input" value="true" checked>
<label for="connmon_auto_true">Yes</label>
<input type="radio" name="connmon_automaticmode"
	id="connmon_auto_false" onchange="automaticTestEnableDisable(this)" class="input" value="false">
...
<input type="checkbox" name="connmon_schdays" id="connmon_mon" class="input" value="Mon" style="margin-left:0;"><label for="connmon_mon">Mon</label>
...
<input type="radio"
	...
	class="input" value="EveryX" checked>
	<label for="schmode_everyx">Every X hours/minutes</label>
<input type="radio"
	onchange="scheduleModeToggle(this)"
	name="schedulemode" id="schmode_custom"
	class="input" value="Custom">
	<label for="schmode_custom">Custom</label>
</div>
<div style="margin-bottom:0;" class="schedulesettings" id="schfrequency">
	<span class="schedulespan">Frequency</span>
	<span style="color:#fff;margin-left:3px;">Every</span>
...
<div class="schedulesettings">
	...
	<span class="schedulespan">Hours</span></a>
	<input data-lpignore="true" autocomplete="off"
	autocapitalize="off" type="text" class="input_25_table"
	...
	class="button_gen cronbutton" name="button" style="display:none;">
</div>
<div class="schedulesettings">
	<a class="hintstyle" href="javascript:void(0);" onclick="settingHint(2);">
	<span class="schedulespan">Minutes</span></a>
	<input data-lpignore="true" autocomplete="off"
	autocapitalize="off" type="text" class="input_25_table"
...
<input type="radio" name="connmon_storagelocation"
   id="connmon_storageloc_jffs" class="input" value="jffs" checked>
<label for="connmon_storageloc_jffs">JFFS</label>
<input type="radio" name="connmon_storagelocation"
   id="connmon_storageloc_usb" class="input" value="usb">
...
<table width="100%" border="0" align="center" cellpadding="4"
 cellspacing="0" bordercolor="#6b8fa3" class="FormTable" style="border:0;">
<tr class="apply_gen" valign="top" height="35px">
  <td colspan="2" class="savebutton">
   <input type="button" onclick="saveConfig('Navigate3');"
    value="Save" class="button_gen savebutton" name="button" id="btnSaveNavigate3">
   <img id="imgSaveNavigate3"
    style="display:none;vertical-align:middle;margin:5px;" src="images/InternetScan.gif" />
  </td>
</tr>
</table>
</div>
<div id="Navigate4" style="display:none;">
  <table width="100%" border="1" align="center" cellpadding="2"
   cellspacing="0" bordercolor="#6b8fa3" class="FormTable SettingsTable" id="table_notificationstypes">
<thead class="collapsible-jquery" id="notificationstypes">
<tr>
<td colspan="2">Notification Event Types</td>
</tr>
</thead>
<tr>
  <td align="center" style="padding:0;">
  <button type="button"
   ...
   onclick="jyNavigate(1,'NotificationType',5);"
   id="btnNotificationTypeNavigate1">Ping Test<br/>Success</button>
  <button type="button"
   class="button_gen notificationtypenavbutton"
   onclick="jyNavigate(2,'NotificationType',5);"
   id="btnNotificationTypeNavigate2">Ping Test<br/>Failure</button>
  <button type="button"
   class="button_gen notificationtypenavbutton"
   onclick="jyNavigate(3,'NotificationType',5);"
   id="btnNotificationTypeNavigate3">Ping<br/>Threshold</button>
  <button type="button"
   class="button_gen notificationtypenavbutton"
   onclick="jyNavigate(4,'NotificationType',5);"
   id="btnNotificationTypeNavigate4">Jitter<br/>Threshold</button>
  <button type="button"
   class="button_gen notificationtypenavbutton"
   onclick="jyNavigate(5,'NotificationType',5);"
   id="btnNotificationTypeNavigate5">Line Quality<br/>Threshold</button>
</td>
</tr>
</table>
<!--
**== "Ping Test Success" Event Type ==**
-->
<div id="NotificationTypeNavigate1">
  <div style="line-height:10px;">&nbsp;</div>
    <table width="100%" border="1" align="center" cellpadding="2"
     cellspacing="0" bordercolor="#6b8fa3" class="FormTable SettingsTable" id="table_pingtestOKtypes">
    <thead class="collapsible-jquery" id="pingtestOKtypes">
      <tr><td colspan="2">Ping Test Success Notifications</td></tr>
    </thead>
    <tr class="even" id="rowpingtestOKtypes">
    <td class="settingname">Enabled notification methods</td>
    <td class="settingvalue">
    <div id="pingtesttypefields" style="padding-top:5px;padding-bottom:5px;">
    <input type="checkbox"
      name="connmon_notifications_pingtest"
      id="connmon_pingtest_email" class="input"
      value="Email"><label for="connmon_pingtest_email" class="notificationtype">Email</label>
    <input type="checkbox"
      name="connmon_notifications_pingtest"
      id="connmon_pingtest_webhook" class="input"
      value="Webhook"><label for="connmon_pingtest_webhook" class="notificationtype">Webhook</label>
    <input type="checkbox"
      name="connmon_notifications_pingtest"
      id="connmon_pingtest_pushover" class="input"
      value="Pushover"><label for="connmon_pingtest_pushover" class="notificationtype">Pushover</label>
    <input type="checkbox"
      name="connmon_notifications_pingtest"
      id="connmon_pingtest_custom" class="input"
      value="Custom"><label for="connmon_pingtest_custom" class="notificationtype">Custom</label>
</div>
</td>
</tr>
</table>
<div style="line-height:10px;">&nbsp;</div>
  <table width="100%" border="0" align="center" cellpadding="4"
   ...
   <tr class="apply_gen" valign="top" height="35px">
    <td colspan="2" class="savebutton">
      <input type="button" onclick="saveConfig('NotificationTypeNavigate1');"
       value="Save" class="button_gen savebutton" name="button" id="btnSaveNotificationTypeNavigate1">
    <img id="imgSaveNotificationTypeNavigate1" style="display:none;vertical-align:middle;margin:5px;"
      src="images/InternetScan.gif" />
    </td>
   </tr>
  </table>
...
<!--
**-------------------------------------**
** Added by Martinski W. [2025-Nov-14] **
**-------------------------------------**
**== "Ping Test Failure" Event Type ==**
-->
<div id="NotificationTypeNavigate2">
  <div style="line-height:10px;">&nbsp;</div>
    <table width="100%" border="1" align="center" cellpadding="2"
     cellspacing="0" bordercolor="#6b8fa3" class="FormTable SettingsTable" id="table_pingtestFailedTypes">
    <thead class="collapsible-jquery" id="pingtestFailedTypes">
      <tr><td colspan="2">Ping Test Failure Notifications</td></tr>
    </thead>
    <tr class="even" id="rowpingtestFailedTypes">
    <td class="settingname">Enabled notification methods</td>
    <td class="settingvalue">
    <div id="pingtestFailedtypefields" style="padding-top:5px;padding-bottom:5px;">
    <input type="checkbox"
      name="connmon_notifications_pingtest_failed"
      id="connmon_pingtest_failed_email" class="input"
      value="Email"><label for="connmon_pingtest_failed_email" class="notificationtype">Email</label>
    <input type="checkbox"
      name="connmon_notifications_pingtest_failed"
      id="connmon_pingtest_failed_webhook" class="input"
      value="Webhook"><label for="connmon_pingtest_failed_webhook" class="notificationtype">Webhook</label>
    <input type="checkbox"
      name="connmon_notifications_pingtest_failed"
      id="connmon_pingtest_failed_pushover" class="input"
      value="Pushover"><label for="connmon_pingtest_failed_pushover" class="notificationtype">Pushover</label>
    <input type="checkbox"
      name="connmon_notifications_pingtest_failed"
      id="connmon_pingtest_failed_custom" class="input"
      value="Custom"><label for="connmon_pingtest_failed_custom" class="notificationtype">Custom</label>
</div>
</td>
</tr>
</table>
<div style="line-height:10px;">&nbsp;</div>
  <table width="100%" border="0" align="center" cellpadding="4"
   ...
   <tr class="apply_gen" valign="top" height="35px">
    <td colspan="2" class="savebutton">
      <input type="button" onclick="saveConfig('NotificationTypeNavigate2');"
       value="Save" class="button_gen savebutton" name="button" id="btnSaveNotificationTypeNavigate2">
    <img id="imgSaveNotificationTypeNavigate2" style="display:none;vertical-align:middle;margin:5px;"
      src="images/InternetScan.gif" />
    </td>
   </tr>
  </table>
...
<!--
**== "Ping Threshold" Event Type ==**
-->
<div id="NotificationTypeNavigate3">
  <div style="line-height:10px;">&nbsp;</div>
  <table width="100%" border="1" align="center" cellpadding="2"
   cellspacing="0" bordercolor="#6b8fa3" class="FormTable SettingsTable" id="table_pingthresholdtypes">
  <thead class="collapsible-jquery" id="pingthresholdtypes">
     <tr><td colspan="2">Ping Threshold Notifications</td></tr>
  </thead>
  ...
  <td class="settingvalue">
    <input autocomplete="off" type="text" maxlength="8"
     class="input_12_table removespacing" name="connmon_notifications_pingthreshold_value" value="30.000"
...
<!--
**== "Jitter Threshold" Event Type ==**
-->
<div id="NotificationTypeNavigate4">
  <div style="line-height:10px;">&nbsp;</div>
  <table width="100%" border="1" align="center" cellpadding="2"
   cellspacing="0" bordercolor="#6b8fa3" class="FormTable SettingsTable" id="table_jitterthresholdtypes">
  <thead class="collapsible-jquery" id="jitterthresholdtypes">
    <tr><td colspan="2">Jitter Threshold Notifications</td></tr>
  </thead>
  <tr class="even" id="rowjitterthresholdvalue">
  <td class="settingname">Threshold value</td>
  <td class="settingvalue">
  <input autocomplete="off" type="text" maxlength="8"
   class="input_12_table removespacing" name="connmon_notifications_jitterthreshold_value" value="15.000"
   onkeypress="return validator.isNumberFloat(this, event)"
   onkeyup="validateNumberSetting(this,9999,0)"
   onblur="validateNumberSetting(this,9999,0);formatNumberSetting3DP(this)" />
  </td>
...
<!--
**== "Line Quality Threshold" Event Type ==**
-->
<div id="NotificationTypeNavigate5">
  <div style="line-height:10px;">&nbsp;</div>
  <table width="100%" border="1" align="center" cellpadding="2"
   cellspacing="0" bordercolor="#6b8fa3" class="FormTable SettingsTable" id="table_linequalitythresholdtypes">
  <thead class="collapsible-jquery" id="linequalitythresholdtypes">
    <tr><td colspan="2">Line Quality Threshold Notifications</td></tr>
  </thead>
  <tr class="even" id="rowjlinequalitythresholdvalue">
  <td class="settingname">Threshold value</td>
  <td class="settingvalue">
  <input autocomplete="off" type="text" maxlength="8"
   class="input_12_table removespacing" name="connmon_notifications_linequalitythreshold_value" value="90.000"
   onkeypress="return validator.isNumberFloat(this, event)"
   onkeyup="validateNumberSetting(this,9999,0)"
   onblur="validateNumberSetting(this,9999,0);formatNumberSetting3DP(this)" />
  </td>
  ...
  <td class="settingname">Enabled notification methods</td>
														...
														<table width="100%" border="0" align="center" cellpadding="4"
															...
															<tr class="apply_gen" valign="top" height="35px">
																<td colspan="2" class="savebutton">
																	<input type="button"
																		onclick="saveConfig('NotificationTypeNavigate5');"
																		value="Save" class="button_gen savebutton"
																		name="button"
																		id="btnSaveNotificationTypeNavigate5">
																	<img id="imgSaveNotificationTypeNavigate5"
																		style="display:none;vertical-align:middle;margin:5px;"
																		src="images/InternetScan.gif" />
																</td>
															</tr>
													...
													<table width="100%" border="1" align="center" cellpadding="2"
														...
														<tr><td colspan="2">Notification Methods and Integrations</td></tr>
														</thead>
														<tr>
															<td align="center" style="padding:0;">
																<button type="button"
...
<tr class="even" id="rowpushoveruserkey">
  ...
  <td class="settingvalue">
    <input autocorrect="off" autocapitalize="off"
      ...
      style="text-align:left;padding-left:5px;"
      class="input_32_table removespacing"
      name="connmon_notifications_pushover_userkey" value=""
      onkeypress="return validator.isString(this,event);"
      data-lpignore="true" />
  </td>
</tr>
<tr class="even" id="rowpushoverapi">
  ...
  <td class="settingvalue">
    <input autocorrect="off" autocapitalize="off"
     type="text" maxlength="255"
     style="text-align:left;padding-left:5px;width:440px"
     class="input_32_table removespacing"
     name="connmon_notifications_pushover_api" value=""
     onkeypress="return validator.isString(this,event);"
     data-lpignore="true" />
  </td>
</tr>
...
<tr class="even" id="rowinfluxdbVersion">
  ...
  <input type="radio" name="connmon_notifications_influxdb_version"
    ...
    <label for="connmon_notifications_influxdb_version_20">2.0</label>
  <input type="radio" name="connmon_notifications_influxdb_version"
    id="connmon_notifications_influxdb_version_18" class="input" value="1.8">
    <label for="connmon_notifications_influxdb_version_18">1.8</label>
  </td>
</tr>
...
<tr class="even" id="rowinfluxdbapitoken">
  ...
  <td class="settingvalue">
    <input autocorrect="off" autocapitalize="off"
     ...
     style="text-align:left;padding-left:5px;width:440px"
     class="input_32_table removespacing"
     name="connmon_notifications_influxdb_apitoken" value=""
     onkeypress="return validator.isString(this,event);"
     data-lpignore="true" />
  </td>
</tr>
